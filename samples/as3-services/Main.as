...
package {
	...
	import application.ServicesContext;
	import flash.display.Sprite;
	import flash.events.Event;
	import org.flashapi.hummingbird.HummingbirdAS;
	
	[SWF(frameRate="30", width="340", height="150", backgroundColor="0xffffff")]
	public class Main extends Sprite {
		...
		private function init(e:Event):void {
			...
			HummingbirdAS.setApplicationContext(new ServicesContext(), this.stage);
		}
	}
}