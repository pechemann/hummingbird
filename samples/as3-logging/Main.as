...
package {
	...
	import application.LoggingContext;
	import flash.display.Sprite;
	import flash.events.Event;
	import org.flashapi.hummingbird.HummingbirdAS;
	
	[SWF(frameRate="30", width="280", height="100", backgroundColor="0xffffff")]
	public class Main extends Sprite {
		...
		private function init(e:Event):void {
			...
			HummingbirdAS.setApplicationContext(new LoggingContext(), this.stage);
		}
	}
}