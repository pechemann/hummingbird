...
package {
	...
	import application.LazyEvalContext;
	import flash.display.Sprite;
	import flash.events.Event;
	import org.flashapi.hummingbird.HummingbirdAS;
	
	[SWF(frameRate="30", width="260", height="100", backgroundColor="0xffffff")]
	public class Main extends Sprite {
		...
		private function init(e:Event):void {
			...
			HummingbirdAS.setApplicationContext(new LazyEvalContext(), this.stage);
		}
	}
}